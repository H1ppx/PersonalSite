...
import stylesCss from 'themes/personalsite/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_personalsite_componentCss']) {
    
    document['_vaadintheme_personalsite_componentCss'] = true;
  }
